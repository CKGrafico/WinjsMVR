...
!function(){"use strict";var t=Windows.UI.Notifications,e=t.ToastNotificationManager,a=e.createToastNotifier();WinJS.Namespace.define("YeahToast",{show:function(e){if("string"==typeof e){var o=e;e={title:o}}var n=this.getToastXml(e),i=new t.ToastNotification(n);e.onactivated&&(i.onactivated=e.onactivated),e.ondismissed&&(i.ondismissed=e.ondismissed),e.onfailed&&(i.onfailed=e.onfailed),a.show(i)},schedule:function(e){var o=this.getToastXml(e),n=new t.ScheduledToastNotification(o,e.due);return e.onactivated&&(n.onactivated=e.onactivated),e.ondismissed&&(n.ondismissed=e.ondismissed),e.onfailed&&(n.onfailed=e.onfailed),n.id=this.getUniqueToastId(),a.addToSchedule(n),n},cancel:function(t){for(var e=a.getScheduledToastNotifications(),o=0,n=e.length;n>o;o++)e[o].id===t&&a.removeFromSchedule(e[o])},getToastXml:function(a){var o=t.ToastTemplateType.toastText01;o=a.template?a.template:this.getTemplateFromOptions(a);var n=e.getTemplateContent(o);if(a.audio,a.imgsrc){var i=n.getElementsByTagName("image");i[0].setAttribute("src",a.imgsrc)}var s=n.getElementsByTagName("text");return s.forEach(function(t,e){0==e?t.appendChild(n.createTextNode(a.title)):1==e?t.appendChild(n.createTextNode(a.textContent)):t.appendChild(n.createTextNode(a.textContent2))}),n},getUniqueToastId:function(){return Math.floor(1e8*Math.random())},getTemplateFromOptions:function(e){return e.imgsrc&&e.title&&e.textContent&&e.textContent2?t.ToastTemplateType.toastImageAndText04:e.imgsrc&&e.title&&e.textContent?e.title.length>e.textContent.length?t.ToastTemplateType.toastImageAndText03:t.ToastTemplateType.toastImageAndText02:e.imgsrc&&e.title?t.ToastTemplateType.toastImageAndText01:e.title&&e.textContent&&e.textContent2?t.ToastTemplateType.toastText04:e.title&&e.textContent?e.title.length>e.textContent.length?t.ToastTemplateType.toastText03:t.ToastTemplateType.toastText02:t.ToastTemplateType.toastText01}})}();
!function(e){"use strict";var a=Windows.Storage.ApplicationData.current,n=a.roamingSettings,t=Windows.ApplicationModel.Resources.Core.ResourceContext.getForCurrentView(),g=WinJS.Class.define(function(){this.setLanguage(n.values.AppLanguage||t.languages[0]||"en-US")},{translate:function(e){var a=WinJS.Resources.getString(e);return a.empty?"*"+e:a.value},setLanguage:function(e){Windows.Globalization.ApplicationLanguages.primaryLanguageOverride=e,n.values.AppLanguage=e,this.language=e},getLanguage:function(){return this.language}});e.languages=new g,e.translate=languages.translate,Handlebars.registerHelper("i18n",translate)}(window,jQuery,_);
!function(t,i,e){"use strict";var n=WinJS.Class.define(function(){},{baseConstructor:function(t){var i=t;e.each(i.events,function(t,n){var s=n.split(" "),o=s[0];s[1]||null,i.on(o,e.bind(i[t],i))})},options:{},events:{},initialize:function(){},trigger:function(t,i){var n={type:t};e.extend(n,i),WinJS.Application.queueEvent(n)},on:function(t,i){WinJS.Application.addEventListener(t,i)}}),s=WinJS.Class.derive(n,function(t){this.customConstructor(t)},{customConstructor:function(t){if(e.extend(this.options,t),this.model){var n=this.model;this.model=new n}this.$el=i("<"+this.tagName+"/>").addClass(this.className).attr("id",this.idName),this.el=this.$el[0];var s=this;e.each(this.domEvents,function(t,n){var o=n.split(" "),a=o[0],r=o[1]||"",l=e.bind(s[t],s),c=s.$el.attr("id"),u=s.$el.prop("tagName").toLowerCase();r=c?u+"#"+c+" "+r:u+r,i("body").on(a,r,l)}),this.baseConstructor(this),this.initialize()},tagName:"div",className:"",idName:"view",templatesPath:"/templates/",templatesExtension:".hbs",templateName:null,template:function(t){return this.templateName?i("<div/>").loadFromTemplate({template:this.templateName,path:this.templatesPath,extension:this.templatesExtension,data:e.extend({},t,this.options)}).html():void 0},dom:{},classes:{},events:{},domEvents:{},model:null,render:function(){return this.$el.html(this.template(this.options)),this}}),o=WinJS.Class.derive(n,function(t){this.customConstructor(t)},{customConstructor:function(t){e.extend(this.options,t),this.set("url",this.options.url||this.get("url")||null),this.baseConstructor(this),this.initialize()},attributes:{},get:function(t){return t?this.attributes[t]||null:attributes},set:function(t,i){this.attributes[t]=i},toJSON:function(){return JSON.stringify(attributes)},collection:[],resetCollection:function(){this.trigger("resetCollection"),this.collection=[]},getJSON:function(t){var n=this,s=this.get("url");s&&i.ajax({url:s,async:t.async||!1,data:t||{}}).done(function(t){var s;if(s="string"==typeof t?i.parseJSON(t):t,"object"==typeof s){var o;for(o in s)break;s=s[o]}e.each(s,n.addToCollection,n),n.trigger("addToCollectionAll",s)})},addToCollection:function(t){this.trigger("addToCollection",t),this.collection.push(t)}}),a=WinJS.Class.derive(n,function(t){e.extend(this.options,t),this.$wrapper=i(this.options.wrapper)||i("body"),this.pages=this.options.pages||{},WinJS.Navigation.addEventListener("navigated",e.bind(this.onNavigate,this)),this.baseConstructor(this),this.initialize()},{navigate:function(t){WinJS.Navigation.navigate(t)},history:function(){return WinJS.Navigation.history},location:function(){return WinJS.Navigation.location},back:function(t,i){WinJS.Navigation.back(t).done(i)},addPage:function(t,i){this.pages[t]=i},onNavigate:function(t){var i=t.detail.location,e=this.pages[i],n=e.render();this.$wrapper.html(n.$el)}});WinJS.Class.extend=function(t,i,e,n){return"object"==typeof i?WinJS.Class.derive(t,function(t){this.customConstructor(t)},i,e):WinJS.Class.derive(t,i,e,n)},WinJS.Namespace.define("WinjsMVR",{View:s,Model:o,Router:a})}(window,jQuery,_);
!function(){"use strict";var i=WinJS.Application,n=Windows.ApplicationModel.Activation;Windows.Storage.ApplicationData.current,i.onactivated=function(i){i.detail.kind===n.ActivationKind.launch&&(i.detail.previousExecutionState!==n.ApplicationExecutionState.terminated&&(WinJS.Application.onsettings=function(i){var n=i.detail.e.request.applicationCommands,t=new Windows.UI.ApplicationSettings.SettingsCommand("privacy","Privacy",function(){window.open("http://ckgrafico.com/privacy/")});n.append(t);var n=i.detail.e.request.applicationCommands,a=new Windows.UI.ApplicationSettings.SettingsCommand("animalia","Mundo Animalia",function(){window.open("http://www.mundoanimalia.com/animales_en_adopcion")});n.append(a)},App.start("Home")),i.setPromise(WinJS.UI.processAll()))},i.oncheckpoint=function(){},i.start()}(window);
!function(t){"use strict";var r=Windows.Storage.ApplicationData.current;r.roamingSettings,t.App={Views:{},Models:{},start:function(t){this.router=new WinjsMVR.Router({wrapper:"#wrapper"}),this.router.addPage(t,new this.Views[t]),this.router.navigate(t)}}}(window,jQuery,_);
!function(a){var t={};a.fn.loadFromTemplate=function(e){var o=!1;options=a.extend({},a.fn.loadFromTemplate.dafaults,e);var l={getData:function(){if("object"==typeof options.data)l.renderData.call(this,options.data);else{var t=this;a.ajax({url:options.data,async:!1}).done(function(a){l.renderData.call(t,a)})}},renderData:function(a){var e=t[options.template](a);this.append(e).each(options.callbackPerEach),l.doCallback.call(this)},compileTemplate:function(){var e=a(options.template);if(e.length)t[options.template]=Handlebars.compile(options.template),l.getData.call(this);else{var o=this;a.ajax({url:options.path+options.template+options.extension,async:!1}).done(function(a){t[options.template]=Handlebars.compile(a),l.getData.call(o)})}},doCallback:function(){o||(o=!0,options.callback?options.callback.call(this):"function"==typeof e&&e.call(this))}};return"function"==typeof t[options.template]?l.getData.call(this):l.compileTemplate.call(this),this},a.fn.loadFromTemplate.dafaults={template:"template",data:"data.json",path:"/templates/",extension:".hbs",callback:a.noop,callbackPerEach:a.noop}}(jQuery);
!function(t,s,e,a){"use strict";App.Models.Animals=WinJS.Class.extend(WinjsMVR.Model,{attributes:{url:"http://adopta.azurewebsites.net",p:0},events:{collectionAdd:"onCollectionAdd"},getAnimals:function(){var t=this.get("tags");t?this.getJSON({path:this.get("path")||"",tags:t,p:this.get("p")||0,async:!0,lang:a.getLanguage().substring(0,2)}):this.getJSON({path:this.get("path")||"",p:this.get("p")||0,async:!0,lang:a.getLanguage().substring(0,2)})},changeFilters:function(){var t=this.get("filters"),s={perros:null,gatos:null,machos:null,hembras:null};e.each(t,function(t){s[t.id]=t.selected}),s.perros&&s.gatos||!s.perros&&!s.gatos?this.set("path","animales_en_adopcion"):s.perros?this.set("path","perros_en_adopcion"):s.gatos&&this.set("path","gatos_en_adopcion"),s.machos&&s.hembras||!s.machos&&!s.hembras?this.set("tags",""):s.machos?this.set("tags","macho"):s.hembras&&this.set("tags","hembra")},onCollectionAdd:function(){this.collection.pop()}})}(window,jQuery,_,window.languages);
!function(e,i){"use strict";App.Views.Home=WinJS.Class.extend(WinjsMVR.View,{idName:"home",events:{changeFilter:"onChangeFilter"},dom:{loading:".loadmore"},initialize:function(){i(this.dom.loading).hide(),this.header=new App.Views.Header,this.content=new App.Views.List({filters:this.header.filtersArray})},render:function(){return this.$el.html(""),this.$el.append(this.header.render().$el),this.$el.append(this.content.render().$el),this},onChangeFilter:function(e){this.content.changeFilter(e)}})}(window,jQuery,_);
!function(e,s,a,t,i){"use strict";App.Views.Header=WinJS.Class.extend(WinjsMVR.View,{idName:"header",templateName:"header",initialize:function(){this.filtersArray=[{id:"perros",name:t("Perros"),selected:!0},{id:"gatos",name:t("Gatos"),selected:!0},{id:"machos",name:t("Machos"),selected:!0},{id:"hembras",name:t("Hembras"),selected:!0}],this.filters=new App.Views.Filters({filters:this.filtersArray});var e=i.getLanguage();this.languagesArray=[{id:"es-ES",name:t("Castellano"),selected:"es-ES"===e?!0:!1},{id:"ca-ES",name:t("Catalán"),selected:"ca-ES"===e?!0:!1}],this.languages=new App.Views.Langs({langs:this.languagesArray})},render:function(){return this.$el.html(this.template()),this.$el.append(this.filters.render().$el),this.$el.append(this.languages.render().$el),this}})}(window,jQuery,_,window.translate,window.languages);
!function(e,t,i){"use strict";App.Views.List=WinJS.Class.extend(WinjsMVR.View,{idName:"list",tagName:"article",className:"group list",model:App.Models.Animals,templateName:"list",defmax:600,max:600,domEvents:{"click #viewmore":"loadMore"},events:{addToCollectionAll:"moreLoaded",resetCollection:"onReset"},dom:{loading:".loadmore"},initialize:function(){this.model.set("filters",this.options.filters),this.model.changeFilters(),t(this.dom.loading).show(),this.model.getAnimals()},render:function(){return this.$el.html(""),this},loadMore:function(e){t(this.dom.loading).show();var i=t(e.currentTarget);i.remove(),this.model.set("p",this.model.get("p")+1),this.model.getAnimals()},moreLoaded:function(e){t(this.dom.loading).hide(),this.$el.append(this.template({animals:e}))},changeFilter:function(e){this.model.resetCollection(),t(this.dom.loading).show(),this.model.set("p",0),this.model.set("filters",i.extend(this.options.filters,e)),this.model.changeFilters(),this.model.getAnimals()},onReset:function(){this.$el.html("")}})}(window,jQuery,_,window.languages);
!function(e,t,i){"use strict";App.Views.Filters=WinJS.Class.extend(WinjsMVR.View,{domEvents:{"click .filter-tab":"onClickFilter"},events:{changeFilter:"onChangeFilter"},idName:"filters_tab",templateName:"filters",filters:[],dom:{filtertab:".filter-tab"},render:function(){return this.$el.html(this.template(this.options)),this},onClickFilter:function(e){var s=t(e.currentTarget),l=s.data("id"),r=this;i.each(this.options.filters,function(e){e.id===l&&(e.selected=!e.selected,r.trigger("changeFilter",e))}),s.toggleClass("selected")},getFilter:function(e){return i.find(this.options.filters,function(t){return t.id===e})},onChangeFilter:function(){this.options.filters,this.getFilter("perros").selected||this.getFilter("gatos").selected||(this.toggleFilter(this.getFilter("perros")),this.toggleFilter(this.getFilter("gatos"))),this.getFilter("perros").selected||this.getFilter("hembras").selected||(this.toggleFilter(this.getFilter("perros")),this.toggleFilter(this.getFilter("hembras")))},toggleFilter:function(e){e.selected=!e.selected,t("#animals-"+e.id).toggleClass("selected")}})}(window,jQuery,_);

!function(a,e,t,n,i,s){"use strict";App.Views.Langs=WinJS.Class.extend(WinjsMVR.View,{domEvents:{"click .lang-tab":"onClickLang"},idName:"langs",templateName:"langs",dom:{langTab:".lang-tab"},render:function(){return this.$el.html(this.template(this.options)),this},onClickLang:function(a){var l=e(a.currentTarget),o=l.data("id");t.each(this.options.langs,function(a){a.selected=!a.selected,a.id===o&&n.setLanguage(a.id)}),e(this.dom.langTab).toggleClass("selected"),s.show({title:i("El cambio se hará efectivo al reiniciar la aplicación")})}})}(window,jQuery,_,window.languages,window.translate,YeahToast);